...
## a)
* The process was  a bit difficult i couldnt get it by using sudo apt install torbrowser-launcher and ofc before that sudo apt updating. Then i went to download it from the browser on my debian and at the end i got this error when trying to open it from the terminal.
